...
let rectangle1 = Rectangle(width: 4, height: 7)
    ...
    var heightInCentimeters: Double {
        didSet {
            if heightInInches != oldValue {
                print("\(heightInInches) you changed it")
            }
        }
    }
...
var person = Height(heightInInches: 96)
print(person.heightInCentimeters)
person.heightInCentimeters = 72
print(person.heightInInches)
/*:
