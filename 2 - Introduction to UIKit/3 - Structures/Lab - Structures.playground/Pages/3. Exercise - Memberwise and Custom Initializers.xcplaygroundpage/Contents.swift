...
let favoritBook = Book(title: "Unbroken", author: "Lisa", pages: 473, price: 14.99)

print("My favorit book is \(favoritBook.title), it is by \(favoritBook.author), has \(favoritBook.pages) pages, and costs $\(favoritBook.price) ")
/*:
...
let laptop2 = Laptop(screenSize: 25, yearPurchased: 2025)
/*:
...
let height = Height(centimeters: 65)
