 ...
 */
func areaOfRectangle(x: Double, y: Double) -> Double? {
    guard x > 0 && y > 0 else { return nil }
    return x * y
}

print(areaOfRectangle(x: 1, y: -2))
...
func createUser() -> User? {
    guard let firstNameTextField = firstNameTextField.text else { return nil }
    guard let lastNameTextField = lastNameTextField.text else { return nil }
    guard let ageTextField = ageTextField.text else { return nil }
