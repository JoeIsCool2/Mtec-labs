...
struct RunningWorkout {
    ...
    var averageMileTime: Double {
        self.time * (1600 / self.distance)
    }
}
let runner1 = RunningWorkout(distance: 42_000, time: 120, elevation: 6859)
print(runner1.averageMileTime)
/*:
...
struct Steps {
    ...
    func willSet() {
        if self.steps >= self.goal {
            print("Nice Jobo you reached your goal")
        }
    }
}
let playerOneSteps = Steps(steps: 9999, goal: 10000)
playerOneSteps.willSet()
