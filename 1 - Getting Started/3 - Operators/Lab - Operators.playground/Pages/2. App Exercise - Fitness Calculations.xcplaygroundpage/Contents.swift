 ...
 */
let heartRate1 = 78, heartRate2 = 86, heartRate3 = 95
...
let heartRate1D: Double = 78, heartRate2D: Double = 86, heartRate3D: Double
 = 95
let addedHRD = heartRate1D + heartRate2D + heartRate3D
let averageHRD = addedHRD / 3
// yes it is different because there are doubles now so they can have deciamals
